...
<script type="text/javascript">
  ...
  <div class="conNotes">
  <p>Under Construction: The final look for this page will include links that will allow Member's to quickly look for their favorite Artist's, Album's, and Song's and vote on them, all in one easy to reach area!</p>
  </div>
<div class="genre-page">

    <h1>Genres</h1>
                    <nav class="genre">
                        <ul class="mainFormInput"> 
